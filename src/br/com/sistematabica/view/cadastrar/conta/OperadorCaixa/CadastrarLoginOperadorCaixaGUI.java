...
/**Tela de cadastro de login de operador.
 * 
 ...
 * 
 */
public class CadastrarLoginOperadorCaixaGUI extends javax.swing.JFrame {

    private String emailAtual = "";
    private Style style = new Style();
    private DadoPessoal dados;
    /**
     * Creates new form CadastrarLoginGUI
     */
    public CadastrarLoginOperadorCaixaGUI() {
        initComponents();
    }
    
    /**Contrutor que reebe dados do operador e seta na tela.
     * 
     * @author Joel Henrique
     * @author Evelyn Mayara
     * @author Lucas Gabriel
     ...
     * 
     */
    public CadastrarLoginOperadorCaixaGUI(DadoPessoal dados) {
        this();
        this.dados = dados;
    }
    ...
    private void initComponents() {
        ...
        setTitle("Cadastrar login do operador");
        setAlwaysOnTop(true);
        setResizable(false);
        ...
        lblEntrar.setBounds(10, 50, 380, 70);
    ...
    private void jLabel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel1MouseClicked
        ...
        if(new OperadorCaixaController().validarEmail(this.txtUsuario.getText())) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadastrarLoginOperadorCaixaGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CadastrarLoginOperadorCaixaGUI().setVisible(true);
            }
        });
    }
