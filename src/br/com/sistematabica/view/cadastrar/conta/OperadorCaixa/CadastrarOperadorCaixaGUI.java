...
package br.com.sistematabica.view.cadastrar.conta.OperadorCaixa;
...
/**Tela de cadastro de operador de caixa.
 * 
 ...
 * 
 */
public class CadastrarOperadorCaixaGUI extends javax.swing.JFrame {
     ...
     */
    public CadastrarOperadorCaixaGUI() {
        initComponents();
        style.jLabelEditImage(lblAddIcon, "");
    }
    
    /**Contrutor que recebe um dado do operador.
     * 
     * @author Joel Henrique
     * @author Evelyn Mayara
     * @author Lucas Gabriel
     ...
     * 
     */
    public CadastrarOperadorCaixaGUI(DadoPessoal dado) {
        this();
        
        this.txtBairro.setText(dado.getBairro());
        this.txtCEP.setText(dado.getCEP());
        this.txtCPF.setText(dado.getCPF());
        this.txtCidade.setText(dado.getCidade());
        this.txtComplemento.setText(dado.getComplemento());
        this.txtDataNascimento.setText(dado.getDataNascimento());
        this.txtNomeCompleto.setText(dado.getNomeCompleto());
        this.txtOutroTelefone.setText(dado.getNumeroCelular());
        this.txtTelefonePrincipal.setText(dado.getPrimeiroTelefone());
        this.boxSexo.setSelectedItem(dado.getSexo());
        this.boxUF.setSelectedItem(dado.getUF());
        this.urlIcon = dado.getURLFoto();
        style.jLabelEditImage(this.lblIcon, "/br/com/sistematabica/imagens/usuario/contas/"+dado.getURLFoto()+"g.png");
    
    }

    /**Método que retorna os dados que estiver setado na view.
     * 
     * @author Joel Henrique
     * @author Evelyn Mayara
     * @author Lucas Gabriel
     ...
     * 
     */
    private DadoPessoal objectDadoPessoal() {
...
//        dadosGerais.setNumeroRegistro(new GerenteDAOOracle().idMax_GERENTE() + 1);
    ...
    private void lblButtonSalvarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblButtonSalvarMouseClicked
        ...
        if ((!this.txtNomeCompleto.getText().equals(""))
            ...
            // Chamando a tela cadastro de login passando com parametro os dados, para que lá possa se setado o objeto OperadorCaixa
            CadastrarLoginOperadorCaixaGUI cadastrarOperadorCaixaGUI = new CadastrarLoginOperadorCaixaGUI(objectDadoPessoal());
    ...
    private void lblAddIconMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblAddIconMouseClicked
        ...
        this.dispose();
        CadastrarPerfilIconGUI perfilIconGUI = new CadastrarPerfilIconGUI(this.objectDadoPessoal());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadastrarOperadorCaixaGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CadastrarOperadorCaixaGUI().setVisible(true);
            }
        });
    }
