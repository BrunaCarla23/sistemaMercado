...
package br.com.sistematabica.view.cadastrar.conta.cliente;
...
public class CadastrarClienteGUI extends javax.swing.JFrame {
    ...
    /**Construtor que recebe um dadoPessoal do cliente.
     * 
     * @author Joel Henrique
     * @author Evelyn Mayara
     * @author Lucas Gabriel
     ...
     * 
     */
    public CadastrarClienteGUI(DadoPessoal dado) {
        this();
    ...
    public DadoPessoal objectDadoPessoal() {
...
//        dadosGerais.setNumeroRegistro(new GerenteDAOOracle().idMax_GERENTE() + 1);
    ...
    private void lblAddIconMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblAddIconMouseClicked
        ...
        this.dispose();
        CadastrarPerfilIconGUI perfilIconGUI = new CadastrarPerfilIconGUI(objectDadoPessoal());
