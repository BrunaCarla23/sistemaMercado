...
/**Tela de cadastro de login do gerente.
 * 
 ...
 * 
 */
public class CadastrarLoginGerenteGUI extends javax.swing.JFrame {
     ...
     */
    public CadastrarLoginGerenteGUI() {
        initComponents();
    }
    
    /**Contrutor que recebe dados de um gerente.
     * 
     * @author Joel Henrique
     * @author Evelyn Mayara
     * @author Lucas Gabriel
     ...
     * 
     */
    public CadastrarLoginGerenteGUI(DadoPessoal dados) {
        this();
        this.dados = dados;
    }
    ...
    private void jLabel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel1MouseClicked
        ...
        if(new GerenteController().validarEmail(this.txtUsuario.getText())) {
        
            this.jLabel1.setEnabled(false);
           Gerente gerente = new Gerente(dados, this.txtUsuario.getText(), this.txtSenha.getText());


           //new CRUDContaController().inserir(gerente);
           new GerenteController().inserir(gerente);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadastrarLoginGerenteGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CadastrarLoginGerenteGUI().setVisible(true);
            }
        });
    }
