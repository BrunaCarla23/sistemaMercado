...
/** Tela Swing onde vai setar os dados de um gerente selecionado para que possa fazer a alteração
 * 
 ...
 * 
 */
public class MeuPerfilGerenteGUI extends javax.swing.JFrame {
     ...
     */
    public MeuPerfilGerenteGUI() {
        initComponents();
        style.jLabelEditImage(lblAddIcon, "");
    }
    
    /** Construtor que vai receber como parametro um gerente que vai setar na view
     * 
     * @author Joel Henrique Silva Santos
     * @author Evelyn Mayara da Silva Santos
     * @author Lucas Gabriel Silva Santos
    ...
    public MeuPerfilGerenteGUI(Gerente gerente) {
        this();

        gerenteAtual = gerente;
        
        // sentando o operador que vai ser alterado na view
        this.txtBairro.setText(gerente.getDados().getBairro());
        this.txtCEP.setText(gerente.getDados().getCEP());
        this.txtCPF.setText(gerente.getDados().getCPF());
        this.txtCidade.setText(gerente.getDados().getCidade());
        this.txtComplemento.setText(gerente.getDados().getComplemento());
        this.txtDataNascimento.setText(gerente.getDados().getDataNascimento());
        this.txtNomeCompleto.setText(gerente.getDados().getNomeCompleto());
        this.txtOutroTelefone.setText(gerente.getDados().getNumeroCelular());
        this.txtTelefonePrincipal.setText(gerente.getDados().getPrimeiroTelefone());
        this.boxSexo.setSelectedItem(gerente.getDados().getSexo());
        this.boxUF.setSelectedItem(gerente.getDados().getUF());
        this.txtEmail.setText(gerente.getNomeLogin());
        this.txtSenha.setText(gerente.getSenhaLogin());
        this.urlIcon = gerente.getDados().getURLFoto();
        style.jLabelEditImage(this.lblIcon, "/br/com/sistematabica/imagens/usuario/contas/"+gerente.getDados().getURLFoto()+"g.png");
        this.urlIcon = gerente.getDados().getURLFoto();
    }

    /** Método que vai pegar os valores que estiver na view para um objeto Gerente e retorna
     * 
     * @author Joel Henrique Silva Santos
     * @author Evelyn Mayara da Silva Santos
     * @author Lucas Gabriel Silva Santos
    ...
    public Gerente objectConta() {
        ...
        dadosGerais.setNumeroRegistro(this.gerenteAtual.getDados().getNumeroRegistro());
        ...
        Gerente gerente = new Gerente(dadosGerais,this.txtEmail.getText(),this.txtSenha.getText());
    ...
    private void lblButtonSalvarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblButtonSalvarMouseClicked
        ...
        gerenteController.alterar(objectConta());
        //gerenteController.showGUI();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MeuPerfilGerenteGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MeuPerfilGerenteGUI().setVisible(true);
            }
        });
    }
