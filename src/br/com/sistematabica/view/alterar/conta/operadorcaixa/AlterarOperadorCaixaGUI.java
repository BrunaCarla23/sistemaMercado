...
package br.com.sistematabica.view.alterar.conta.operadorcaixa;
...
/** Tela Swing onde vai setar os dados de um operador selecionado para que possa fazer a alteração
 * 
 ...
 * 
 */
public class AlterarOperadorCaixaGUI extends javax.swing.JFrame {


    private String emailAtual = "";
    private static OperadorCaixa operadorCaixaAtual;
     ...
     */
    public AlterarOperadorCaixaGUI() {
        initComponents();
        style.jLabelEditImage(lblAddIcon, "");
    }
    
    /** Construtor que vai receber como parametro um operador que vai setar na view
     * 
     * @author Joel Henrique Silva Santos
     * @author Evelyn Mayara da Silva Santos
     * @author Lucas Gabriel Silva Santos
     * 
     * @param operadorCaixa OperadorCaixa - Operador de caixa
     * 
     */
    
    public AlterarOperadorCaixaGUI(OperadorCaixa operadorCaixa) {
        this();

        operadorCaixaAtual = operadorCaixa;
        
        this.emailAtual = operadorCaixa.getNomeLogin();
        // sentando o operador que vai ser alterado na view
        this.txtBairro.setText(operadorCaixa.getDados().getBairro());
        this.txtCEP.setText(operadorCaixa.getDados().getCEP());
        this.txtCPF.setText(operadorCaixa.getDados().getCPF());
        this.txtCidade.setText(operadorCaixa.getDados().getCidade());
        this.txtComplemento.setText(operadorCaixa.getDados().getComplemento());
        this.txtDataNascimento.setText(operadorCaixa.getDados().getDataNascimento());
        this.txtNomeCompleto.setText(operadorCaixa.getDados().getNomeCompleto());
        this.txtOutroTelefone.setText(operadorCaixa.getDados().getNumeroCelular());
        this.txtTelefonePrincipal.setText(operadorCaixa.getDados().getPrimeiroTelefone());
        this.boxSexo.setSelectedItem(operadorCaixa.getDados().getSexo());
        this.boxUF.setSelectedItem(operadorCaixa.getDados().getUF());
        this.txtEmail.setText(operadorCaixa.getNomeLogin());
        this.txtSenha.setText(operadorCaixa.getSenhalogin());
        this.urlIcon = operadorCaixa.getDados().getURLFoto();
        style.jLabelEditImage(this.lblIcon, "/br/com/sistematabica/imagens/usuario/contas/"+operadorCaixa.getDados().getURLFoto()+"g.png");
        this.urlIcon = operadorCaixa.getDados().getURLFoto();
    }

    /** Método que vai pegar os valores que estiver na view para um objeto OperadorCaixa e retorna
     * 
     * @author Joel Henrique Silva Santos
     * @author Evelyn Mayara da Silva Santos
     * @author Lucas Gabriel Silva Santos
     * 
     * @return OperadorCaixa - Operador de caixa
     * 
     */
    
    public OperadorCaixa objectConta() {
        ...
        dadosGerais.setNumeroRegistro(this.operadorCaixaAtual.getDados().getNumeroRegistro());
        dadosGerais.setTipo("OperadorCaixa");
        ...
        OperadorCaixa operadorCaixa = new OperadorCaixa(dadosGerais,this.txtEmail.getText(),this.txtSenha.getText());
    ...
    private void initComponents() {
        ...
        setTitle("Alterar operador de caixa");
        setResizable(false);
        ...
        pnlPrincipal.add(lblButtonSalvar, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 470, 96, 35));
        ...
        pnlPrincipal.add(lblButtonVoltar, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 470, 97, 35));
        ...
        pnlPrincipal.add(lblSalvar, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 470, 97, 36));
        ...
        pnlPrincipal.add(lblVoltar, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 470, 97, 36));

        lblSenha.setForeground(new java.awt.Color(255, 255, 255));
        lblSenha.setText("Senha:");
        pnlPrincipal.add(lblSenha, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 410, -1, -1));

        lblEmail.setForeground(new java.awt.Color(255, 255, 255));
        lblEmail.setText("Email:");
        pnlPrincipal.add(lblEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 360, -1, -1));
        pnlPrincipal.add(txtSenha, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 430, 210, -1));
        pnlPrincipal.add(txtEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 380, 210, -1));
    ...
    private void lblButtonSalvarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblButtonSalvarMouseClicked
        ...
        if ((!this.txtNomeCompleto.getText().equals(""))
            ...
            JOptionPane.showMessageDialog(null, "Ops, tem campo vazio!");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AlterarOperadorCaixaGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AlterarOperadorCaixaGUI().setVisible(true);
            }
        });
    }
