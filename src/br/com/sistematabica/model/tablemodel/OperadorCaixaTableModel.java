...
import br.com.sistematabica.model.Teste;
import java.util.ArrayList;
import javax.swing.table.AbstractTableModel;

/**Table model do operador.
 * 
 ...
 * 
 */
public class OperadorCaixaTableModel extends AbstractTableModel{
    
    private ArrayList<OperadorCaixa> dados = new ArrayList<>();
    ...
    public OperadorCaixa getList(int id) {
        return dados.get(id);
    }
    ...
    public void addRow(OperadorCaixa teste) {
